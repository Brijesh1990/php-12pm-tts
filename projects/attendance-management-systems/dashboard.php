...
<div class="row">
   <div class="col-md-7 mt-5">
      ...
      <h2 class='text-white ms-5'>Good Day
   </h2>
   </div>
...
<button class="btn btn-lg btn-danger">Add Attendance</button>
<hr class='w-25 border border-primary'/>
<div class="row">
<div class="col-md-12 p-3 m-3 bg-primary shadow rounded-4 shadow text-white">Manage Attendance</div>
</div>
<!-- pie chart -->
